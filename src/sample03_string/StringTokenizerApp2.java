...
public class StringTokenizerApp2 {
	...
	public static void main(String[] args) {
		...
		String text1 = "김우빈,영업2팀,과장,010-1111-1111";
		String text2 = "강하나,,인턴,010-2222-2222";
		
		// split 메소드
		System.out.println("### split메소드로 문자열 가르기");
		...
		/*
		 * StringTokenizer는 구분기호로 나누어진 토큰이 빈 문자일 경우 토큰을 무시한다.
		 * 	String text1 = "김우빈, 영업2팀,과장,010-1111-1111";
		 * 	String text2 = "강하나,,인턴,010-2222-2222";
		 * 
		 * 	text1을 토큰화하면 "김우빈", "영업2팀", "과장", "010-1111-1111	"로 토큰화된다.
		 * 	text2을 토큰화하면 "강하나", "인턴", "010-2222-2222"로 토큰화된다.
		 */
