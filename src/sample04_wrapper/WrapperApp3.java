...
public class WrapperApp3 {
	...
	public static void main(String[] args) {
		...
		// int Integer.parstInt(String text) : 숫자로 구성된 문자열을 정수로 변환해서 반환한다.
		int num1 = Integer.parseInt("1234");
		int num2 = Integer.parseInt("12");
//		int num2 = Integer.parseInt("124a"); // 에러 NumberFormatException  
//		int num3 = Integer.parseInt("100,000"); // 에러 NumberFormatExecption 오로지 숫자만
